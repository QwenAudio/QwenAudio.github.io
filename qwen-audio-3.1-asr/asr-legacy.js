...
const resultViews = {
  dialect: { label:'Internal dialect ASR', image:'assets/figures/dialect-internal-asr-31.png', alt:'Internal dialect ASR CER comparison across 16 dialects', kicker:'Internal dialect ASR', number:'10.38%', title:'Macro CER across 16 dialects', description:'Qwen-Audio-3.1-ASR has the lowest CER on 11 of 16 test sets. Equal-weight macro CER: Qwen 10.38%, Doubao-ASR 20.23%, Tencent Hy-ASR-3.0-preview 17.13%.', tags:['Lower is better','16 varieties','Internal benchmark'] },
  consistency: { label:'Internal dialect AST', image:'assets/figures/dialect-internal-ast-31.png', alt:'Internal dialect AST semantic sentence accuracy across 11 dialects', kicker:'Internal dialect AST', number:'82.10%', title:'Macro semantic sentence accuracy', description:'Equal-weight mean across 11 dialect test sets. Qwen-Audio-3.1-ASR has the highest semantic sentence accuracy on 10 of 11 sets; Tencent leads on Cantonese.', tags:['Higher is better','11 dialects','Internal benchmark'] },
  publicDialect: { label:'Public ASR / AST', image:'assets/figures/dialect-public-asr-ast-31.png', alt:'KeSpeech AST and WSYue ASR CER comparison', kicker:'Public dialect benchmarks', number:'6/11', title:'Test sets with the lowest CER', description:'Qwen-Audio-3.1-ASR has the lowest CER on 5 of 9 KeSpeech AST subsets and on WSYue-long ASR. Tencent leads on the other 5 sets. Both tasks report CER; lower is better.', tags:['KeSpeech · AST','WSYue · ASR','Lower is better'] },
