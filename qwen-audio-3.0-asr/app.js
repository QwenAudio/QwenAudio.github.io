const dialectSamples = [
  ...
  { short: '青', location: 'Qingdao', name: 'Qingdao dialect', sourceText: 'Source-language transcript not supplied.', translation: 'A supplied speech sample in the Qingdao variety.', file: 'qingdao.m4a' },
  { short: '沪', location: 'Shanghai', name: 'Shanghainese', sourceText: 'Source-language transcript not supplied.', translation: 'A supplied speech sample in Shanghainese.', file: 'shanghai.m4a' },
  { short: '赣', location: 'Nanchang', name: 'Nanchang dialect', sourceText: 'Source-language transcript not supplied.', translation: 'A supplied speech sample in the Nanchang variety.', file: 'nanchang.m4a' },
  { short: '甬', location: 'Ningbo', name: 'Ningbo dialect', sourceText: 'Source-language transcript not supplied.', translation: 'A supplied speech sample in the Ningbo variety.', file: 'ningbo.m4a' },
  { short: '客', location: 'Hakka', name: 'Hakka', sourceText: 'Source-language transcript not supplied.', translation: 'A supplied speech sample in Hakka.', file: 'hakka.m4a' },
  { short: '杭', location: 'Hangzhou', name: 'Hangzhou dialect', sourceText: 'Source-language transcript not supplied.', translation: 'A supplied speech sample in the Hangzhou variety.', file: 'hangzhou.m4a' },
  { short: '温', location: 'Wenzhou', name: 'Wenzhounese', sourceText: 'Source-language transcript not supplied.', translation: 'A supplied speech sample in Wenzhounese.', file: 'wenzhou.m4a' },
  { short: '湘', location: 'Hunan', name: 'Hunan dialect', sourceText: 'Source-language transcript not supplied.', translation: 'A supplied speech sample in the Hunan variety.', file: 'hunan.m4a' },
  { short: '闽', location: 'Fujian', name: 'Fujian dialect', sourceText: 'Source-language transcript not supplied.', translation: 'A supplied speech sample in the Fujian variety.', file: 'fujian.m4a' },
  { short: '苏', location: 'Suzhou', name: 'Suzhou dialect', sourceText: 'Wu Chinese speech from Suzhou, Jiangsu.', translation: 'A speech sample from the Suzhou variety of Wu Chinese.', file: 'dialects/suzhou.wav' }
];
...
const resultViews = {
  ...
  industry: { label:'Industry recall', image:'assets/figures/industry-radar.png', alt:'Industry entity recall radar across 15 domains', kicker:'Industry entity recognition', number:'15/15', title:'Domains led in entity recall', description:'Across the internal industry-term evaluation, Qwen-Audio-3.0-ASR reports the highest entity recall in every evaluated domain.', tags:['Higher is better','Entity recall','Internal benchmark'] },
  polishing: { label:'Polishing', image:'assets/figures/polishing-scores.png', alt:'Readability and faithfulness of native polishing', kicker:'Native polishing', number:'3.43', title:'Readability score', description:'Native single-pass polishing substantially improves readability while maintaining faithfulness, approaching an external post-rewrite baseline.', tags:['Single pass','Readable output','Faithfulness'] },
